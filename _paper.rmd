...
<!-- render time -->
The work remaining at runtime consists mostly in rendering the frames of the tour as specified by the selection of the parameters. The application is made with __shiny__ [@chang_shiny_2021]. The global view is created first with __ggplot2__ [@wickham_ggplot2_2016] which is then rendered to an interactive html widget with __plotly__ [@sievert_interactive_2020]. The tour view is created in __spinifex__ [@spyrison_spinifex_2020], which creates the manual tour basis array, and facilitates similar rendering to html widget.
