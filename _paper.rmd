...
Version 0.2.0 of the package can be installed from CRAN using the following __R__ code:
...
Alternatively, the cheem viewer shiny app can be directly accessed at https://ebsmonash.shinyapps.io/cheem_initial/.  
