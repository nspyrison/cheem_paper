...
XXX: NS: not as bad as I remember, but a couple, remove them?
```{r}
cheem::chocolates$Name[c(26, 74)]
```
...
NS: Sugar is slightly better imo, but fiber is fine.
