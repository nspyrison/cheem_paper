...
```{r globalview, echo=F, out.width = "100%", fig.cap = "Global view; approximations of the data and SHAP-spaces. Orietation of the basis contributions are illustrated on a unit circle. Linked brushing allows pbservations brushed in one plot to be selected in others. This selection is also used to in the proceeding view and their corresponding informaion is displayed in an interactive table. Hovering the cursor over an observation displays a tooltip with row number/name information. In the classification case, misclassified points are circled in red. This view prvides an orientenation to select a primary and comparison observation, key targets in the following tour."}
