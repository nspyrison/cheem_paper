...
The radial tour starts from the attribution projection of the misclassified observation (left plot). The important variables identifed by SHAP are `b_d` and `wgt` in contrast to `f_l`. 

varies the contribution of bill length (b_l) as this variable differs most from the contribution of the comparison observation. Downplaying the contribution of bill length is crucial to the linear explanation of this observation being misclassified.
