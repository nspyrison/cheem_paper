...
predictors to arrive at a prediction. ``Local variable attributions'',
which provide a point estimate of the linear variable importance in the
vicinity of one observation, are one local XAI method. These can be
considered to be linear projections and can be further explored to
understand the interactions between variables used to make predictions
across the predictive model surface as well as understand the structure
of local explanations for observations, whether outlier are present,
whether segments can be identified. Here we describe interactive linear
