...
\title{Exploring Local Explanations of Nonlinear Models Using Animated Linear
Projections}


\author*[1]{\fnm{Nicholas} \sur{Spyrison}}\email{spyrison@gmail.com}

\author[2]{\fnm{Dianne} \sur{Cook}}\email{dicook@monash.edu}

\author[3]{\fnm{Przemyslaw} \sur{Biecek}}\email{przemyslaw.biecek@pw.edu.pl}

\affil*[1]{\orgdiv{Faculty of Information Technology}, \orgname{Monash
University}, \orgaddress{\street{Wellington Rd}, \city{Clayton}, \postcode{VIC 3800}, \country{Australia}}}

\affil[2]{\orgdiv{Dept of Econometrics and Business Statistics}, \orgname{Monash University}, \orgaddress{\street{Wellington Rd}, \city{Clayton}, \postcode{VIC 3800}, \country{Australia}}}

\affil[3]{\orgdiv{Faculty of Mathematics and Information Science}, \orgname{Warsaw University of Technology}, \orgaddress{\street{Koszykowa 75}, \city{Warsaw}, \postcode{00-662}, \country{Poland}}}
...
for computing SHAP and other LVA values, including \texttt{treeshap} \citep{kominsarczyk_treeshap_2023}, \texttt{fastshap} \citep{fastshap},
...
\citet{molnar2022} provides good explanations of the
...
\ref{fig:classificationcase}c, \ref{fig:regressioncase}b) to help
...
highlighted across plots (Figure \ref{fig:regressioncase}a \& b).
The information corresponding to the selected points is populated on a
dynamic table (Figure \ref{fig:regressioncase}d). These interactions
...
\item
  ...
  split (mtry) of \(\sqrt{p}\), and minimum terminal node size of 
  \(max(1, n/500)\). While regression models use 125 tree, \(p/3\) variables at split, and 
  \(max(5, n/500)\) minimum terminal node size.
\item
  \textbf{Local explanation:} Tree SHAP is calculated for \emph{each}
  observation using the package \textbf{treeshap}
  \citep{kominsarczyk_treeshap_2023}. We opt to find the attribution of
...
Alternatively, a version of the cheem viewer shiny app can be directly accessed at \url{https://ebsmonash.shinyapps.io/cheem/}, the development version of the package is available at \url{https://github.com/nspyrison/cheem}, and documentation of the package can be found at \url{https://nspyrison.github.io/cheem/}.
