...
- Editor listed: Please include the name of the Action Editor who handled your submission in the \\editor{} tag _NS--- todo_
...
- Captions NOT in italics, bold. NS `codeface` and \\url{}, but not egregious.
- Tables and figures should not overfill margins. NA (manual check, reference urls run over)
...
- Capitalization of book titles, etc: The parts in italics (book names, journal names, conf names) should be title case. (First letter of each word capitalized except for little words like "and" and "or".) NS See above subitem comment/.
