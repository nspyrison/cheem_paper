...
%     Do not define proof environment if already defined. (Thank you James Martens)
%
...
%%%%%============================================================
%% NS: treat @ as letter in order of operations to resolve error:
%% ! You can't use `\spacefactor' in vertical mode.
\makeatletter %% Using \makeatletter and \makeatother isn't
%% working for whole file; trying to remove problematic @'s (non escaped)
%% Trying to remove leading @ from: abbrvbib, usehyper, preprint
%%%%%============================================================
\newif\if@abbrvbib\@abbrvbibfalse %% remove leading @
\DeclareOption{abbrvbib}{\@abbrvbibtrue}

\newif\if@usehyper\@usehypertrue %% remove leading @
\DeclareOption{nohyperref}{\@usehyperfalse}
\DeclareOption{hyperref}{\@usehypertrue}

% declare preprint option, which creates a preprint version ready for
% upload to, e.g., arXiv
\newif\if@preprint\@preprintfalse %% remove leading @
...
%%%%%============================================================
%% NS: revert @ as other in order of operations to resolve error:
%% ! You can't use `\spacefactor' in vertical mode.
\makeatother
%%%%%============================================================
...
%\makeatletter %% NS: ~~~ This does beaks again
\if@usehyper
\RequirePackage[colorlinks=false,allbordercolors={1 1 1}]{hyperref}
\fi

\if@abbrvbib
%\makeatother %% NS: ~~~ This is fine
...
% \widowpenalty=10000
% \clubpenalty=10000
% %% NS: THIS ONE IS AN ISSUE EITHER WAY ~~~
% % \makeatother %% NS: ~~~
